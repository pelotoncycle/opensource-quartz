...
#define	VIDEO_SET_BRIGHTNESS(b)	video_set_brightness(b)
#define	VIDEO_GET_BRIGHTNESS()	video_get_brightness()
#else
#define	VIDEO_SET_BRIGHTNESS(b)
#define	VIDEO_GET_BRIGHTNESS()
