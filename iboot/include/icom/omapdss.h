...
struct omap_dss_board_info {
	...
	/* DSS platform specific functions to enable/disable the DSS related voltage domains */
	int (*dss_platform_enable)(void);
	void (*dss_platform_disable)(void);
...
extern void omap_display_shutdown(void);
#else
static inline int omap_display_init(struct omap_dss_board_info *board_data)
{
	return 0;
}
static inline void omap_display_shutdown(void) { }
...
struct omap_dss_device {
	...
	bool skip_init;
	int min_fck_per_pck;	/* Replace CONFIG_OMAP2_DSS_MIN_FCK_PER_PCK */
