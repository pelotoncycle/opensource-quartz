...
int load_part(block_dev_desc_t * dev_desc,
		int (*part_import)(block_dev_desc_t *dev_desc, int part, disk_partition_t *info));
int save_part(block_dev_desc_t * dev_desc, int part_num,
...
static inline int load_part(block_dev_desc_t * dev_desc,
		int (*part_import)(block_dev_desc_t *dev_desc, int part, disk_partition_t *info)) {
	return -1;
}
static inline int save_part(block_dev_desc_t * dev_desc, int part_num,
		int (*part_export)(block_dev_desc_t *dev_desc, int part, disk_partition_t *info)) {
	return -1;
}
#endif
