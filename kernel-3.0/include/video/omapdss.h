...
#define OMAP_DSS_LCD_DITHER_MASK \
	(OMAP_DSS_LCD_DITHER_SP | OMAP_DSS_LCD_DITHER_SPTP_2 | OMAP_DSS_LCD_DITHER_SPTP_4)
...
enum omap_panel_config {
	...
	OMAP_DSS_LCD_DITHER_SP		= 1<<21,
	OMAP_DSS_LCD_DITHER_SPTP_2	= 1<<22,
	OMAP_DSS_LCD_DITHER_SPTP_4	= 1<<23,
	OMAP_DSS_LCD_GATE_HVSYNC	= 1<<24,
};
...
#else
static inline void omap_dss_backlight_init_brightness(int brightness) {}
static inline int omap_dss_backlight_get(void) {return 0;}
