...
// AX88xxx Power sequence control define. (Chip on board project only)
#define REGULATOR_ETHERNET_3V3		"vnet_d3v3"
#define GPIO_ETHERNET_EN		33
#define GPIO_ETHERNET_RST		36
#define ETHERNET_RESET_RELEASE_TIME	10+5+(1+10) // Unit: mS
// Reset pin release timing after 3.3V supply: Trise3 + Tdelay32 + (Trst_pu=Tclk +Trst). Here Trst=10mS @ XTL25P clock cycle = 25MHz)
// Reference: 9.4 Power-up Sequence,  page 80 @ AX88772B specification (Document No: AX88772B/V1.04/08/10/11)
#endif	// CONFIG_MACH_OMAP4_QUARTZ

//Laker: removed, apply another solution to do PHY_POWER_UP
//#define ETHERNET_PHY_PS_CONFIG		0x0900	// Ethernet PHY Power Save configuration
// The value (0x0900) here is from reference ethernet dongle (EEPROM address: 0x18, high byte, low byte ignored)
