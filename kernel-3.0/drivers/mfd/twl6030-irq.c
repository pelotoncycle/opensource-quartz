...
static const char* twl6032_interrupt_name[24] = {
	"Bit 0	PWRON",
	"Bit 1	RPWRON",
	"Bit 2	BAT_VLOW",
	"Bit 3	RTC_ALARM",
...
extern int twl6030_pih_print_irq;
	...
	while (!kthread_should_stop()) {
		...
		for (i = 0; int_sts; int_sts >>= 1, i++) {
			...
			if (int_sts & 0x1) {
				...
				if(twl6030_pih_print_irq) {
					pr_info("twl6030-irq : waked up by %s\n", twl6032_interrupt_name[i]);
				}
...
/** http://git.omapzoom.org/?p=kernel/omap.git;a=commit;h=ab8bf5ef81488caed9bbcc2d72b9912ff683b845
 * Mask BAT_VLOW at the primary interrupt source.
 */
