...
#define dprintk(fmt, arg...) \
	do { printk(KERN_INFO "[%s] " fmt, SENSOR_NAME, ##arg); } while (false)
#else
#define dprintk(fmt, arg...) \
	do { } while (false)
#endif
...
#define SENSOR_NAME 			SAGA_GSENSOR_DRIVER_NAME
#define ABSMIN				-512
#define ABSMAX				512
...
static void bma2x2_work_func(struct work_struct *work)
{
	...
	//printk(KERN_INFO "Acc-sensor: X:%d Y:%d Z:%d",acc.x,acc.y,acc.z);
...
static struct device_attribute attributes[] = {
	__ATTR(range, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_range_show, bma2x2_range_store),
	__ATTR(bandwidth, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_bandwidth_show, bma2x2_bandwidth_store),
	__ATTR(mode, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_mode_show, bma2x2_mode_store),
	__ATTR(value, S_IRUGO, bma2x2_value_show, NULL),
	__ATTR(delay, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_delay_show, bma2x2_delay_store),
	__ATTR(enable, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_enable_show, bma2x2_enable_store),
	__ATTR(SleepDur, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_SleepDur_show, bma2x2_SleepDur_store),
	__ATTR(fast_calibration_x, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fast_calibration_x_show, bma2x2_fast_calibration_x_store),
	__ATTR(fast_calibration_y, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fast_calibration_y_show, bma2x2_fast_calibration_y_store),
	__ATTR(fast_calibration_z, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fast_calibration_z_show, bma2x2_fast_calibration_z_store),
	__ATTR(fifo_mode, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fifo_mode_show, bma2x2_fifo_mode_store),
	__ATTR(fifo_framecount, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fifo_framecount_show, NULL),
	__ATTR(fifo_trig, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fifo_trig_show, bma2x2_fifo_trig_store),
	__ATTR(fifo_trig_src, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fifo_trig_src_show, bma2x2_fifo_trig_src_store),
	__ATTR(fifo_data_sel, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_fifo_data_sel_show, bma2x2_fifo_data_sel_store),
	__ATTR(fifo_data_out_frame, S_IRUGO, bma2x2_fifo_data_out_frame_show, NULL),
	__ATTR(reg, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_register_show, bma2x2_register_store),
	__ATTR(chip_id, S_IRUGO, bma2x2_chip_id_show, NULL),
	__ATTR(offset_x, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_offset_x_show, bma2x2_offset_x_store),
	__ATTR(offset_y, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_offset_y_show, bma2x2_offset_y_store),
	__ATTR(offset_z, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_offset_z_show, bma2x2_offset_z_store),
	__ATTR(enable_int, S_IWUSR|S_IWGRP, NULL, bma2x2_enable_int_store),
	__ATTR(int_mode, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_int_mode_show, bma2x2_int_mode_store),
	__ATTR(slope_duration, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_slope_duration_show, bma2x2_slope_duration_store),
	__ATTR(slope_threshold, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_slope_threshold_show, bma2x2_slope_threshold_store),
	__ATTR(high_g_duration, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_high_g_duration_show, bma2x2_high_g_duration_store),
	__ATTR(high_g_threshold, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_high_g_threshold_show, bma2x2_high_g_threshold_store),
	__ATTR(low_g_duration, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_low_g_duration_show, bma2x2_low_g_duration_store),
	__ATTR(low_g_threshold, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_low_g_threshold_show, bma2x2_low_g_threshold_store),
	__ATTR(tap_duration, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_tap_duration_show, bma2x2_tap_duration_store),
	__ATTR(tap_threshold, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_tap_threshold_show, bma2x2_tap_threshold_store),
	__ATTR(tap_quiet, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_tap_quiet_show, bma2x2_tap_quiet_store),
	__ATTR(tap_shock, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_tap_shock_show, bma2x2_tap_shock_store),
	__ATTR(tap_samp, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_tap_samp_show, bma2x2_tap_samp_store),
	__ATTR(orient_mode, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_orient_mode_show, bma2x2_orient_mode_store),
	__ATTR(orient_blocking, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_orient_blocking_show, bma2x2_orient_blocking_store),
	__ATTR(orient_hyst, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_orient_hyst_show, bma2x2_orient_hyst_store),
	__ATTR(orient_theta, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_orient_theta_show, bma2x2_orient_theta_store),
	__ATTR(flat_theta, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_flat_theta_show, bma2x2_flat_theta_store),
	__ATTR(flat_hold_time, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_flat_hold_time_show, bma2x2_flat_hold_time_store),
	__ATTR(selftest, S_IRUGO|S_IWUSR|S_IWGRP, bma2x2_selftest_show, bma2x2_selftest_store),
	__ATTR(softreset, S_IWUSR|S_IWGRP, NULL, bma2x2_softreset_store),
};
		...
		const struct i2c_device_id *id)
{
	...
	if (!i2c_check_functionality(client->adapter, I2C_FUNC_I2C)) {
		dprintk("i2c_check_functionality error");
		err = -EIO;
		goto exit;
	}
	...
	data->pdata->i2c_client_dev = &client->dev;
	
	if (data->pdata->init_platform_hw(data->pdata)) {
	...
	if (create_sysfs_interfaces(&data->input->dev)) {
		dprintk("create sysfs interfaces failed");
		return ERR;
	}
	
	if (sysfs_create_link(&devices_kset->kobj, &data->input->dev.kobj, "accelerometer")) {
...
kfree_exit:
	kfree(data);
init_failed:
	data->pdata->exit_platform_hw(data->pdata);
	kfree(data);
exit:
	return err;
}
 ...
 *
 */
static int bma2x2_disable(struct bma2x2_data *data)
{
 ...
 *
 */
static int bma2x2_enable(struct bma2x2_data *data)
{
	struct sensors_pm_platform_data *pdata = data->pdata;
...
{
	struct bma2x2_data *data = i2c_get_clientdata(to_i2c_client(dev));

	dprintk("SUSPEND");

	data->on_before_suspend = atomic_read(&data->enable);
	return bma2x2_disable(data);
}
