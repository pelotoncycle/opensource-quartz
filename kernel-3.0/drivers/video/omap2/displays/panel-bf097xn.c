/*
 * InnoComm Winmate 9.7-inch panel support
 *
 * Copyright (C) 2011-2013 InnoComm Mobile Technology Corp.
 *
...
static struct omap_video_timings panel_timings = {
	...
	/* @TODO@ James Wu: Workaround solution to make sure LCM workable */
	/* omapdss DPI: Could not find exact pixel clock. Requested 98000 kHz, got 85333 kHz */
	/**
	 * xtot = x_res + hsw + hfp + hbp = 1024 + 240 + 260 + 436 = 1960
	 * ytot = y_res + vsw + vfp + vbp = 768 + 3 + 1 + 4 = 776
	 * HSYNC = pixel_clock / xtot = 85333333 / 1960 = 43537 Hz = 43.537 KHz
...
MODULE_DESCRIPTION("OMAP4 Winmate 9.7-inch Panel");
MODULE_LICENSE("GPL");
