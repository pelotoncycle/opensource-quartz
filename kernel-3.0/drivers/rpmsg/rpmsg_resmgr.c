...
#define NAME_SIZE	50
#define REGULATOR_MAX_TALOS 3
#if defined (CONFIG_MACH_OMAP4_WEDJAT)
#define REGULATOR_MAX	1
#else
#define REGULATOR_MAX	0
#endif
...
static char *regulator_name_talos[REGULATOR_MAX_TALOS] = {
	"cam_pwr_1v8",	/* vusim_supply */
	"cam_csi_1v8",	/* vcxio_supply */	
	"cam_2v8",	/* gpio_51 supply */
};
...
int rprm_regulator_request(struct rprm_elem *e, struct rprm_regulator *obj)
{
	...
	if(machine_is_omap4_talos7() || machine_is_omap4_talos10() || machine_is_omap4_puzzle() ||
		machine_is_omap4_zeus() || machine_is_omap4_olympus()|| machine_is_innocomm_oracle() ||
		machine_is_omap4_quartz() || machine_is_omap4_saga() || machine_is_omap4_pb1icom() || machine_is_omap4_winmate()) {
        reg_name = regulator_name_talos[obj->id - 1];	
...
static void rprm_regulator_release(struct rprm_regulator_depot *obj)
{
	...
	/* Restore orginal voltage */
       ...
       if(machine_is_omap4_talos7() || machine_is_omap4_talos10() || machine_is_omap4_puzzle() ||
		...
		machine_is_omap4_quartz() || machine_is_omap4_saga() || machine_is_omap4_pb1icom() || machine_is_omap4_winmate())
	{	
		//printk("obj->orig_uv=%d",obj->orig_uv);										
	}else
	{
