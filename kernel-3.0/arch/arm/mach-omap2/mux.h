...
#define OMAP_DEVICE_PAD_SUSPEND_GPIO_HI		BIT(6)	/* Config as GPIO output high when suspend*/
#define OMAP_DEVICE_PAD_SUSPEND_GPIO_LOW		BIT(5)	/* Config as GPIO output low when suspend*/
#define OMAP_DEVICE_PAD_SUSPEND		BIT(4)	/* Remux a pad when suspend,*/
#define OMAP_DEVICE_PAD_EARLY_SUSPEND	(BIT(3)|BIT(4))	/* Remux a pad, when early suspend*/
#define OMAP_DEVICE_PAD_SHUTDOWN	BIT(2)	/* Remux a pad, when shutdown*/
#endif
