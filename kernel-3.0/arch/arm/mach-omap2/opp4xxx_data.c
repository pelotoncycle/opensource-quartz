...
#define CONFIG_OMAP4_OPP_USE_NEW_DM_VOLTAGE

/* OMAP4430 */
#define OMAP4430_MPU_M	CONFIG_OMAP4430_VDD_MPU_MARGIN
#define OMAP4430_IVA_M	CONFIG_OMAP4430_VDD_IVA_MARGIN
#define OMAP4430_CORE_M	CONFIG_OMAP4430_VDD_CORE_MARGIN
/* OMAP4460 */
#define OMAP4460_MPU_M	CONFIG_OMAP4460_VDD_MPU_MARGIN
#define OMAP4460_IVA_M	CONFIG_OMAP4460_VDD_IVA_MARGIN
#define OMAP4460_CORE_M	CONFIG_OMAP4460_VDD_CORE_MARGIN
/* OMAP4470 */
#define OMAP4470_MPU_M	CONFIG_OMAP4470_VDD_MPU_MARGIN
#define OMAP4470_IVA_M	CONFIG_OMAP4470_VDD_IVA_MARGIN
#define OMAP4470_CORE_M	CONFIG_OMAP4470_VDD_CORE_MARGIN
...
#ifndef CONFIG_OMAP4_OPP_USE_NEW_DM_VOLTAGE
...
struct omap_volt_data omap443x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP50_UV, 0+OMAP4430_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPP100_UV, 0+OMAP4430_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPTURBO_UV, 0+OMAP4430_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITRO_UV, 0+OMAP4430_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_MPU_OPPNITROSB_UV, 0+OMAP4430_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
...
struct omap_volt_data omap443x_vdd_iva_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPP50_UV, 0+OMAP4430_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPP100_UV, 0+OMAP4430_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4430_VDD_IVA_OPPTURBO_UV, 0+OMAP4430_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap443x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP50_UV, 0+OMAP4430_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4430_VDD_CORE_OPP100_UV, 0+OMAP4430_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP50_UV, 10000+OMAP4460_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPP100_UV, 0+OMAP4460_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPTURBO_UV, 0+OMAP4460_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITRO_UV, 0+OMAP4460_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_MPU_OPPNITROSB_UV, 0+OMAP4460_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap446x_vdd_iva_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPP50_UV, 13000+OMAP4460_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPP100_UV, 0+OMAP4460_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPTURBO_UV, 0+OMAP4460_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPNITRO_UV, 0+OMAP4460_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPNITRO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4460_VDD_IVA_OPPNITROSB_UV, 0+OMAP4460_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPNITROSB, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap446x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP50_UV, 38000+OMAP4460_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_UV, 13000+OMAP4460_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4460_VDD_CORE_OPP100_OV_UV, 13000+OMAP4460_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	/* MPU OPP4 - OPP-Nitro */
/* Default is true because both OMAP4460 Standard device & High performance device support MPU 1.2GHz */
	...
	/* IVA OPP4 - OPP-Nitro */
/* Default is true because both OMAP4460 Standard device & High performance device support IVA 430MHz */
...
struct omap_volt_data omap447x_vdd_mpu_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4470_VDD_MPU_OPP50_UV, 0+OMAP4470_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_MPU_OPP100_UV, 0+OMAP4470_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_MPU_OPPTURBO_UV, 0+OMAP4470_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_MPU_OPPNITRO_UV, 0+OMAP4470_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPNITRO, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_MPU_OPPNITROSB_UV, 0+OMAP4470_MPU_M, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
struct omap_volt_data omap447x_vdd_iva_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4470_VDD_IVA_OPP50_UV, 0+OMAP4470_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPP50, 0xf4, 0x0c, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_IVA_OPP100_UV, 0+OMAP4470_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPP100, 0xf9, 0x16, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_IVA_OPPTURBO_UV, 0+OMAP4470_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPTURBO, 0xfa, 0x23, OMAP_ABB_NOMINAL_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_IVA_OPPNITRO_UV, 0+OMAP4470_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPNITRO, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(OMAP4470_VDD_IVA_OPPNITROSB_UV, 0+OMAP4470_IVA_M, OMAP44XX_CONTROL_FUSE_IVA_OPPNITROSB, 0xfa, 0x23, OMAP_ABB_FAST_OPP),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
#define OMAP4470_VDD_CORE_OPP100H_UV	OMAP4470_VDD_CORE_OPP100_UV
#endif

struct omap_volt_data omap447x_vdd_core_volt_data[] = {
	VOLT_DATA_DEFINE(OMAP4470_VDD_CORE_OPP50_UV, 0+OMAP4470_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP50, 0xf4, 0x0c, OMAP_ABB_NONE),
#ifndef CONFIG_OMAP4_OPP_USE_NEW_DM_VOLTAGE
	VOLT_DATA_DEFINE(OMAP4470_VDD_CORE_OPP100H_UV, 0+OMAP4470_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
#endif
	VOLT_DATA_DEFINE(OMAP4470_VDD_CORE_OPP100_UV, 0+OMAP4470_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP100, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(OMAP4470_VDD_CORE_OPP100_OV_UV, 0+OMAP4470_CORE_M, OMAP44XX_CONTROL_FUSE_CORE_OPP100OV, 0xf9, 0x16, OMAP_ABB_NONE),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap447x_opp_low_def_list[] = {
	...
	/* IVA OPP4 - OPP-Nitro */
/* Default is true because both OMAP4470 Standard device & High performance device support IVA 430MHz */
					  ...
					  unsigned long opp_freq, bool state)
{
	...
	for (i = 0; i < size; i++) {
		...
		if (entry->freq == opp_freq &&
				entry->default_available != state &&
				!strcmp(entry->hwmod_name, oh_name)) {
			entry->default_available = state;
			return 0;
		}
	}
...
#ifdef CONFIG_OMAP4_OPP_USE_NEW_DM_VOLTAGE
/*
...
int __init omap4_opp_init(void)
{
	...
	if (cpu_is_omap443x()) {
		...
		if (rate > OMAP4470_LP_OPP_SET_CORE_DPLL_FREQ / 2) {
			if (omap4_has_iva_500mhz())
				opp_def_list_enable_opp(omap447x_opp_high_def_list,
			...
			if (omap4_has_iva_500mhz())
				opp_def_list_enable_opp(omap447x_opp_low_def_list,
	...
	if (cpu_is_omap443x()) {
		pr_info("4430 MPU margin:+ %u uV\n", OMAP4430_MPU_M);
		pr_info("4430 IVA margin:+ %u uV\n", OMAP4430_IVA_M);
		pr_info("4430 CORE margin:+ %u uV\n", OMAP4430_CORE_M);
	} else if (cpu_is_omap446x()) {
		pr_info("4460 MPU margin:+ %u uV\n", OMAP4460_MPU_M);
		pr_info("4460 IVA margin:+ %u uV\n", OMAP4460_IVA_M);
		pr_info("4460 CORE margin:+ %u uV\n", OMAP4460_CORE_M);
	} else if (cpu_is_omap447x()) {
		pr_info("4470 MPU margin:+ %u uV\n", OMAP4470_MPU_M);
		pr_info("4470 IVA margin:+ %u uV\n", OMAP4470_IVA_M);
		pr_info("4470 CORE margin:+ %u uV\n", OMAP4470_CORE_M);
	}
