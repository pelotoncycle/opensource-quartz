...
static __init int omap4_ldo_trim_init(void)
{
	 ...
	 */
/** http://git.omapzoom.org/?p=kernel/omap.git;a=commit;h=7b3fae390a37b81b426af4681e5f462d1377e0f1
 * ARM: OMAP4: trim_quirks: Repair the wrong comparison
 * The omap_rev() returns value not comparable with CHIP_IS_* constants.
 */
#if 0
