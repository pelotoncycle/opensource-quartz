...
static phys_addr_t omap4_ram_console_mem_addr;
...
static size_t omap4_ram_console_mem_size;
...
void __init omap_ion_init(void)
{
	...
	if (system_512m) {
		...
		omap4_ram_console_mem_size = SZ_1M;
	} else {
...
#if 0
		omap4_ram_console_mem_size = SZ_2M;
#else
		omap4_ram_console_mem_size = SZ_1M;
#endif
	}
	...
	omap4_ram_console_mem_addr = omap4_ion_heap_nonsec_tiler_mem_addr -
				omap4_ram_console_mem_size;
	...
	pr_info("omap4_total_ram_size = 0x%x\n" \
				...
				omap4_ion_heap_tiler_mem_size,
				omap4_ion_heap_nonsec_tiler_mem_size);
	pr_info("omap4_ram_console_mem_size = 0x%x\n", omap4_ram_console_mem_size);
	...
	pr_info("omap4_ram_console_mem_addr = 0x%x\n", omap4_ram_console_mem_addr);
...
phys_addr_t omap_ram_console_mem_addr(void)
{
	return omap4_ram_console_mem_addr;
}
...
size_t omap_ram_console_mem_size(void)
{
	return omap4_ram_console_mem_size;
}
