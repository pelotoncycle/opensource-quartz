...
{
/* From omap.git (p-android-omap-3.0-dev), OMAP4: DPLL cascading: remove unused CM_SHADOW_FREQ_CONFIG2 */
#if 0
...
/* From omap.git (p-android-omap-3.0-dev), OMAP4: DPLL cascading: Removed race between SR calibration and DPLL cascading exit */
#if 0
		ret = -ENODEV;
		goto out;
#else
...
/* From omap.git (p-android-omap-3.0-dev), OMAP4: DPLL cascading: Added dummy symbols to support external modules */
/* These two functions are needed of TI prebuild PVR ko
if any one not define cascading, it need these two 
dummy functions*/
#else
int omap4_dpll_cascading_blocker_hold(struct device *dev)
{
