...
#define OMAP4460_USBHOST_CTX_NUM			9
#define OMAP4470_USBHOST_CTX_NUM			9
...
int omap4_sar_save(void)
{
	...
	/* Save SAR BANK1 */
	if (cpu_is_omap446x())
		sar_save((ARRAY_SIZE(omap446x_sar_ram1_layout) -
			(uhh_save ? 0 : OMAP4460_USBHOST_CTX_NUM)),
			SAR_BANK1_OFFSET, omap446x_sar_ram1_layout);
	else if (cpu_is_omap447x())
		sar_save((ARRAY_SIZE(omap447x_sar_ram1_layout) -
			(uhh_save ? 0 : OMAP4470_USBHOST_CTX_NUM)),
			SAR_BANK1_OFFSET, omap447x_sar_ram1_layout);
	else
