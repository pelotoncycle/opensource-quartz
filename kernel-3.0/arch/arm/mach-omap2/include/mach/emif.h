...
#endif
#else
#define EMIF_DDR_PHY_CTRL_1_BASE_VAL_DLL_MASTER_SENSITIVITY_0	0x049FF
#define EMIF_DDR_PHY_CTRL_1_BASE_VAL_DLL_MASTER_SENSITIVITY_1	0x449FF
#define EMIF_DDR_PHY_CTRL_1_BASE_VAL_DLL_MASTER_SENSITIVITY_2	0x849FF
#endif
/* OMAP4470 TRM:
