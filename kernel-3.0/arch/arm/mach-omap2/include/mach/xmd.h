...
struct xmd_boot_platform_data {
	...
	int reset_pmu_req_active;
	int baseband_reset_gpio;
	int baseband_reset_active;
	int on_off_gpio;
	int on_off_active;
	int pwr_supply_gpio;
	int pwr_supply_active;
	int reset2_gpio;
	int alive_gpio;
	int usb_en_gpio;
	int usb_en_active;
	const char * modem_vbus_regulator;
	...
	struct xmm_pad_mux_config alive_pinmux;
	struct xmm_pad_mux_config usb_en_pinmux;
};
