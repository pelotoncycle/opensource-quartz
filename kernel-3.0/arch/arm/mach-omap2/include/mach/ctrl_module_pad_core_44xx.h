...
/*CAM CLK CONTROL*/
#define CONTROL_CORE_PAD1_FREF_CLK1_OUT				0x4A10019A
#define CONTROL_CORE_PAD1_FREF_CLK2_OUT         		0x4A10019C
#define CONTROL_WKUP_PAD0_FREF_CLK3_OUT				0x4A31E058
#define OMAP44XX_PADCONF_INPUTENABLE0				(1 << 8)
#define OMAP44XX_PADCONF_INPUTENABLE1				(1 << 24)
#define OMAP44XX_PADCONF_PULLTYPESELECT0			(1 << 4)
#define OMAP44XX_PADCONF_PULLUDENABLE0				(1 << 3)
#define OMAP44XX_PADCONF_MUXMODE_MASK0				(7 << 0)
#define OMAP44XX_PADCONF_PULLTYPESELECT1			(1 << 20)
#define OMAP44XX_PADCONF_PULLUDENABLE1				(1 << 19)
#define OMAP44XX_PADCONF_MUXMODE_MASK1				(7 << 16)
#endif
