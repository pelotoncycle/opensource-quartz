...
static inline void __arch_decomp_setup(unsigned long arch_id)
{
	...
	do {
		...
		DEBUG_LL_OMAP4(3, omap4_talos10);
		DEBUG_LL_OMAP4(3, omap4_talos7);
		DEBUG_LL_OMAP4(3, omap4_quartz);		
		DEBUG_LL_OMAP4(3, omap4_saga);				
		DEBUG_LL_OMAP4(3, omap4_zeus);
		DEBUG_LL_OMAP4(3, omap4_olympus);
		DEBUG_LL_OMAP4(3, omap4_wedjat);
		DEBUG_LL_OMAP4(3, omap4_puzzle);
		DEBUG_LL_OMAP4(3, omap4_pb1icom);
		DEBUG_LL_OMAP4(3, omap4_winmate);
