...
#define IO_EXPANDER_IRQ_BASE	OMAP_GPMC_IRQ_END
#define IO_EXPANDER_NR_IRQS	16
#define IO_EXPANDER_IRQ_END	(IO_EXPANDER_IRQ_BASE + IO_EXPANDER_NR_IRQS)
#define NR_IRQS			IO_EXPANDER_IRQ_END
#else
